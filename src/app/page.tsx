...
import { AnimationCloudImage } from "./components/Animation";
    ...
    <main className="min-h-screen relative">
      ...
      <div className="absolute z-20">
        ...
        <div className="px-10 md:px-16 lg:px-24">
          <AnimationCloudImage direction="right">
          ...
          <AnimationCloudImage direction="left" duration={2.1}>
        ...
        <div
          ...
          id="about"
        >
          <AnimationCloudImage direction="left" duration={1.5}>
            <div className="mx-10 sm:mx-16 justify-center flex flex-col gap-16">
              ...
              <div className="flex flex-col gap-7">
                <p className="md:text-xl">
                  ...
                  in business management assistant applications. Our key
                  features include cash flow management, sales analysis, and
                  seamless online integration and storage of sales data.
                </p>
                <p className="md:text-xl">
                  ...
                  your business. Our team is prepared to drive your
                  company&apos;s success. Together, let&apos;s propel your
        ...
        {/* section 3 */}
        <div className="px-10 md:px-16 lg:px-24 pb-64 lg:pb-[500px] xl:pb-[350px] z-50 ">
          <AnimationCloudImage direction="right">
          ...
          <div className="flex flex-col gap-10 mt-64" id="pricing">
            ...
            <AnimationCloudImage direction="bottom">
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-96 sm:gap-x-5 md:gap-y-96 md:gap-x-16 lg:gap-8 xl:gap-16 px-5 mt-24">
                <CardPrice
        ...
        {/* footer */}
        <AnimationCloudImage direction="bottom" duration={1.5}>
          <Footer />
        </AnimationCloudImage>
      </div>
    </main>
